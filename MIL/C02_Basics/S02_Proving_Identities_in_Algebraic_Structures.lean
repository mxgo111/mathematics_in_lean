...
theorem add_left_cancel {a b c : R} (h : a + b = a + c) : b = c := by
  rw [← add_zero b, ← add_neg_cancel a, ← add_assoc, ← add_zero c, ← add_neg_cancel a, ← add_assoc c, add_comm b, add_comm c, h, add_comm a, add_neg_cancel_right]

theorem add_right_cancel {a b c : R} (h : a + b = c + b) : a = c := by
  rw [← add_zero a, ← add_neg_cancel b, ← add_assoc, ← add_zero c, ← add_neg_cancel b, ← add_assoc c, h, add_neg_cancel_right]
